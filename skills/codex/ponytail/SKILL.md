...
> Lokale, hook-freie Variante (nur die Prompt-Regeln, keine Node-Lifecycle-Hooks,
> kein `settings.json`-Schreiben). Modus per Klartext umschalten: sag „ponytail lite“,
> „ponytail ultra“ oder „stop ponytail“. Default: **full**.
...
Switch level by saying: `ponytail lite|full|ultra`.
